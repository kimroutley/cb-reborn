...
- Current `ActionCodeSettings` app IDs:
  - Android: `com.clubblackout.cb_player`
  - iOS: `com.clubblackout.cbPlayer`
...
- [ ] Player IDs match Firebase app registration (`com.clubblackout.cb_player` for Android and `com.clubblackout.cbPlayer` for iOS).
...
- Link opens but Player does not sign in: verify Player `ActionCodeSettings` IDs match Firebase app registration (`com.clubblackout.cb_player` for Android and `com.clubblackout.cbPlayer` for iOS).
